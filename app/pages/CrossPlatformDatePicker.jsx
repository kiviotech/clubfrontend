...
//   const currentDate = new Date();
//   const todayString = currentDate.toISOString().split("T")[0]; // Get current date in YYYY-MM-DD format
...
//         <input
//           type="date"
//           value={value && value !== "Invalid Date" ? value.toISOString().split("T")[0] : ""}
